...
<div class="container-fluid" id="container">
  ...
  <div class="card">
    <div class="card-header">
      <h2 class="mt-2">Gestionar Sistemas en Venta</h2>
    </div>
    <div class="card-body">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-8 mb-3">
            ...
            <input type="text" class="form-control border border-danger" id="nombre" name="nombre" placeholder="RESTOBAR">
          </div>
          <div class="col-4 mb-3">
            <label for="precio" class="form-label">Precio</label>
            <input type="text" class="form-control border border-danger" id="precio" name="precio" onkeypress="return validarInputSoloNumeros(event);" placeholder="75.00">
          </div>
        </div>
      </div>
