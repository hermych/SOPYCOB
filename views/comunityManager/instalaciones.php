<?php require_once('../views/layout/header.php'); ?>
        ...
        <div class="card text-center">
            <div class="card-header">
                <div class="d-sm-flex justify-content-between">
                    <h4 class="mt-2">Agendar Instalaciones</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col mb-1">
                            <label for="cdt" class="form-label fw-bolder">Fecha Instalacion</label>
                            <input type="date" class="form-control border border-danger" id="fecha_instalacion" name="fecha_instalacion">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-auto mb-1">
                            <label for="clave_cdt" class="form-label fw-bolder">Clave de CDT</label>
                            <input type="text" class="form-control" id="clave_cdt" name="clave_cdt" disabled placeholder="Ejm: FactSigefac1">
                        </div>
                        <div class="col mb-1">
                            <label for="usuario_sec" class="form-label fw-bolder">Usuario Sec</label>
                            <input type="text" class="form-control" id="usuario_sec" name="usuario_sec" disabled placeholder="Ejm: COFFEE01">
                        </div>
                        <div class="col mb-1">
                            <label for="clave_sec" class="form-label fw-bolder">Clave Sec</label>
                            <input type="text" class="form-control" id="clave_sec" name="clave_sec" disabled placeholder="Ejm: FactSigefac1">
                        </div>
                        <div class="col mb-1">
                ...
                <div class="modal-footer">
                    <button type="button" id="btnRechazar" class="btn btn-secondary bg-warning text-dark fw-bolder" data-bs-toggle="modal" data-bs-target="#modalRechazar">Rechazar</button>
                    <button type="button" class="btn btn-secondary bg-danger" data-bs-dismiss="modal">Cerrar</button>
                    <button type="button" id="btnEditar" class="btn btn-primary bg-success">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modalRechazar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Rechazar Solicitud de Instalacion</h5>
                </div>
                <div class="modal-body">
                    <label>Motivo de rechazo</label>
                    <textarea id="motivoRechazo" name="motivoRechazo" rows="5" class="form form-control border border-danger"></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" id="btnConfirmarRechazo" class="btn btn-success" disabled>Confirmar</button>
                </div>
            </div>
        </div>
    </div>
