...
function cargarTabla (){
    if($.fn.DataTable.isDataTable( '#bajaServicioTable' )){
        $("#bajaServicioTable").dataTable().fnDestroy();
    }
    /*
    let fechaDesde = $('#desde').val()
    let fechaHasta = $('#hasta').val()
    ...
    let fechaHasta = ''
    let fechaDesde = ''
    let ruta = `../controllers/ReportesViewController.php?method=bajaServiciosFecha&desde=${fechaDesde}&hasta=${fechaHasta}`;
    let dataTable = $("#bajaServicioTable").DataTable({
        ajax: {
            url: ruta,
            method: "GET",
        },
