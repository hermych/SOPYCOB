...
function cargarTabla (){
    ...
    let fechaHasta = $('#hasta').val()
    let cliente = $('#cliente').val()
    let ruta = `../controllers/ReportesViewController.php?method=pagosRealizadosFecha&desde=${fechaDesde}&hasta=${fechaHasta}&cliente=${cliente}`;
...
$('#btnRepExcel').click(function (){
    ...
    let fechaHasta = $('#hasta').val()
    let cliente = $('#cliente').val()
    let ruta = `../controllers/ReportesViewController.php?method=reportePagosRealizadosFecha&desde=${fechaDesde}&hasta=${fechaHasta}&cliente=${cliente}`;
    window.$.ajax({
        type: "GET",
        url: ruta,
        success: function (response) {
