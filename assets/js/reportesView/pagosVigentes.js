...
function traerTotal(){
    ...
    let ruta = `../controllers/ReportesViewController.php?method=totalMontoFecha&desde=${fechaDesde}&hasta=${fechaHasta}&cliente=${cliente}`;
    window.$.ajax({
        type: "GET",
        url: ruta,
        beforeSend: function () {
...
function cargarTabla (){
    ...
    let fechaHasta = $('#hasta').val()
    let cliente = $('#cliente').val()
    let ruta = `../controllers/ReportesViewController.php?method=pagosVigentesFecha&desde=${fechaDesde}&hasta=${fechaHasta}&cliente=${cliente}`;
...
$('#btnRepExcel').click(function (){
    ...
    let fechaHasta = $('#hasta').val()
    let cliente = $('#cliente').val()
    let ruta = `../controllers/ReportesViewController.php?method=reportePagosVigentes&desde=${fechaDesde}&hasta=${fechaHasta}&cliente=${cliente}`;
    window.$.ajax({
        type: "GET",
        url: ruta,
        success: function (response) {
